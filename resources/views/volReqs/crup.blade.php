...
<div class="row justify-content-center">
    <div class="col-md">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{empty($volReq)? route('volReqs.store') : route('volReqs.update',$volReq)}}" method="Post"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <input class="form-control" type="text" name="volReq_title_ar" required
                                        @if(!empty($volReq))value="{{$volReq->volReq_title_ar}}" @else
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-8"><input class="form-control" type="text" name="volReq_title_en"
                                        @if(!empty($volReq))value="{{$volReq->volReq_title_en}}" @else
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select id="state" class="custom-select" name="state" required>
                                    @if(!empty($volReq))
                                    <option value="{{$volReq->state}}" selected>{{__($volReq->state)}}</option>
                                    @endif
