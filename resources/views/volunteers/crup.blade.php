    ...
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form
                        action="{{ empty($volunteer) ? route('volunteers.store') : route('volunteers.update', $volunteer) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="@if (!empty($volunteer)) col-8 @else col-md-10 @endif">
                                <input class="form-control" type="file" name="profile" @if (empty($volunteer)) required @endif>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><input class="form-control" type="text" name="name_ar" value=@if (!empty($volunteer)) "{{ $volunteer->name_ar }}"@else "{{ old('name_ar') }}" @endif>
                            </div>
                            <div class="col-md-2 col-form-label  ">
                                <label for="name_en">{{ __('English Name') }}:</label>
                            </div>
                            <div class="col-md-4"><input class="form-control" type="text" name="name_en" value=@if (!empty($volunteer)) "{{ $volunteer->name_en }}" @else "{{ old('name_en') }}" @endif>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><input class="form-control" type="date" name="birth_date" value=@if (!empty($volunteer)) "{{ $volunteer->birth_date }}"@else "{{ old('birth_date') }}" @endif>
                            </div>
                            <!--email-->
                            <div class="col-md-2 col-form-label  ">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" type="email" value=@if (!empty($volunteer)) "{{ $volunteer->user->email }}" @else "{{ old('email') }}" @endif disabled>
                            </div>
                        </div>
                        <hr>
                        <!--education-->
