                    ...
                    <form action="{{ empty($project) ? route('projects.store') : route('projects.update', $project) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="col-8"><input class="form-control" type="text" name="title_en" @if (!empty($project)) value="{{ $project->title_en }}" @else
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="image" @if (empty($project)) required @endif>
