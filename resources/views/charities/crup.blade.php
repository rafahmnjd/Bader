                ...
                <div class="card-body">
                    <form action="{{ empty($charity) ? route('charities.store') : route('charities.update', $charity) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="@if (!empty($charity)) col-md-8 @else col-md-10 @endif input-group mt-3">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="cover" @if (empty($charity)) required @endif>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-4"><input class="form-control" type="text" name="name_ar" value=@if (!empty($charity)) "{{ $charity->name_ar }}"@else "{{ old('name_ar') }}" @endif>
                            </div>
                            <div class="col-md-2 col-form-label  ">
                                <label for="name_en">{{ __('English Name') }}:</label>
                            </div>
                            <div class="col-4"><input class="form-control" type="text" name="name_en" dir="ltr" value=@if (!empty($charity)) "{{ $charity->name_en }}" @else "{{ old('name_en') }}" @endif>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4"><input class="form-control" type="email" name="email" dir="ltr" value=@if (!empty($charity)) "{{ $charity->email }}" @else "{{ old('email') }}" @endif>
                            </div>
                            {{-- </div> --}}
                            ...
                            <div class="col-4"><input class="form-control" type="text" name="phone" dir="ltr" value=@if (!empty($charity)) "{{ $charity->phone }}"@else "{{ old('phone') }}" @endif>
                            </div>
                            ...
                            <div class="col-4"><input class="form-control" type="text" name="mobile" dir="ltr" value=@if (!empty($charity)) "{{ $charity->mobile }}" @else "{{ old('mobile') }}" @endif>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <input class="form-control" type="text" name="whatsapp" dir="ltr" value=@if (!empty($charity)) "{{ $charity->whatsapp }}" @else "{{ old('whatsapp') }}" @endif>
                            </div>
                            <!--facebook-->
                            <div class="col-md-2 col-form-label  ">
                            ...
                            <div class="col-4">
                                <input class="form-control" type="text" name="facebook" dir="ltr" value=@if (!empty($charity)) "{{ $charity->facebook }}" @else "{{ old('facebook') }}" @endif>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select id="govSelect" class="custom-select">
                                    ...
                                    @foreach ($govs as $gov)
                                        <option value={{ $gov->id }} @if (!empty($charity) && !empty($charity->city->gov) && $charity->city->gov->id == $gov->id) selected @endif>{{ $gov->name_ar }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-4"><input class="form-control" type="text" name="address_ar" value=@if (!empty($charity)) "{{ $charity->address_ar }}" @else "{{ old('address_ar') }}" @endif>
                            </div>
                            <div class="col-md-2 col-form-label  ">
                                <label for="address_en">{{ __('Address_EN') }}:</label>
                            </div>
                            <div class="col-4"><input class="form-control" type="text" name="address_en" dir="ltr" value=@if (!empty($charity)) "{{ $charity->address_en }}" @else "{{ old('address_en') }}" @endif>
                            </div>
                        </div>
                        <!--info-->
                        <div class="row">
    ...
    $(document).ready(function() {
        ...
        govesSelect.on('change', function() {
            ...
            for (key in citiesByState[this.value]) {
                citiesSelect.append("<option value='" + key + "'>" + citiesByState[this.value][key] +
                    "</option>");
            }
        });
    });
