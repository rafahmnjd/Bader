            ...
            <div class="profile-header">
                ...
                <div class="header-links">
                    <ul class="links d-flex align-items-center mt-3 mt-md-0">
                        ...
                        <!-- Artical -->
                        <li class="header-link-item d-flex align-items-center @if (!empty($activities)) active @endif">
                            <a class="pt-1px d-none d-md-block"
                                href="{{ route('charities.show', $charity) }}">{{ __('Activities') }}</a>
                        </li>
                        <!-- Projects -->
                        <li
                            class="header-link-item ml-3 pl-3 border-left d-flex align-items-center @if (!empty($projects)) active @endif">
                            <a class="pt-1px d-none d-md-block"
                                href="{{ route('charities.projects', $charity) }}">{{ __('Projects') }}</a>
                        </li>
                        <!-- Shortage -->
                        <li
                            class="header-link-item ml-3 pl-3 border-left d-flex align-items-center @if (!empty($shortages)) active @endif">
                            <a class="pt-1px d-none d-md-block"
                                href="{{ route('charities.shortage', $charity) }}">{{ __('Shortages') }}</a>
                        </li>
                        <!-- Surplus -->
                        <li
                            class="header-link-item ml-3 pl-3 border-left d-flex align-items-center @if (!empty($surpluses)) active @endif">
                            <a class="pt-1px d-none d-md-block"
