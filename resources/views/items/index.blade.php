            ...
            <div class="card">
                ...
                <div class="card-body text-nowrap overflow-auto font-weight-bolder">
                    <div class="row mx-1 py-2 border-bottom border-top">
                        ...
                        <div class="col-1   p-1 ">{{ __('Category_ar') }}</div>
                        <div class="col-1   p-1 ">{{ __('Name in Arabic') }} </div>
                        <div class="col-1   p-1 ">{{ __('Unite in Arabic') }} </div>
                        <div class="col-1   p-1 ">{{ __('Category_en') }}</div>
                        <div class="col-1   p-1 ">{{ __('Name in English') }} </div>
                        <div class="col-1   p-1 ">{{ __('Unite in English') }}</div>
                    ...
                    <form method="POST" action="{{ route('items.store') }}">
                        ...
                        <div class="row mx-2 py-2">
                            ...
                            <div class="col-1 p-1">
                                <select class=" form-control" type="text" name='cat_ar' value="{{ $item->caat_ar }}" required>
                                    @foreach ($cat_ar as $catr)
                                    <option @if ($catr->cat_ar == $item->cat_ar) selected @endif>{{ $catr->cat_ar }}</option>
                                    @endforeach
                                </select>
